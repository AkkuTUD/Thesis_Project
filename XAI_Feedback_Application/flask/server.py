...
bal.handlers = app.logger.handlers  # pylint: disable=no-member
...
def tiles_split_9_cls_FN():
    ...
    # return redirect(url_for("/tiles_split_9_cls/FN", data_FN=data_FN))
...
def tiles_split_9_cls_FP():
    ...
    # return redirect(url_for("/tiles_split_9_cls/FP", data_FP=data_FP))
